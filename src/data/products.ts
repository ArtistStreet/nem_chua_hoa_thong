...
export const products: Product[] = [
  {
    ...
    image: "/images/nemchua2-HT.jpg",
  },
  {
    slug: "nem-coi",
    name: "Nem Cối",
    desc: `Nem cối của nem chua Hoa Thông có cách làm và sử dụng giống với nem chua nhưng nem cối được 
